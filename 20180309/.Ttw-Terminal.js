module.exports = {
	config : {
		...
		//set to `false` if you want to hide the minimize, maximize and close buttons additionally, set to `"left"` if you want them on the left, like in Ubuntu default : `true` on windows and Linux (ignored on macOS);
		, showWindowControls : ""
		...
		//bellSoundURL : "D:\\Program_Portable\Ttw-Terminal\\dding.wav"
	}
